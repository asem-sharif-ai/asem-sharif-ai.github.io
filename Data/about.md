I'm a recent **AI Graduate**, passionate about **Computer Vision** broadly *(Detection, Classification, Segmentation)*, with particular focus on **Human-Centered Tasks** and **Biometric Technologies**, alongside adjacent domains such as **Autonomous Systems**, **Industrial Inspection**, and **Satellite Imagery**.

I believe in the critical importance of the **Lower-Level Stages** of a project, so I frequently build **Internal Tools** and **Annotation Pipelines** to support the infrastructure that model development ultimately depends on. This reflects my background at the intersection of **Deep Learning** and **Software Engineering**, as I build **Production-Ready Systems** *(Desktop Applications, Interactive Websites)* beyond training models.
